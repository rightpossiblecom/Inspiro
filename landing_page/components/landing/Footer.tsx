      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-1">
            ...
            <p className="text-zinc-500 font-medium leading-relaxed font-sans pr-4">
              Inspiro provides short motivational quotes for daily inspiration. Simple, harmless, and effective.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="mailto:hello@inspiro.app" className="w-10 h-10 rounded-full bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:bg-brand-600 hover:text-white transition-all">
                <Mail size={18} />
              </Link>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-zinc-100 dark:border-zinc-900 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-zinc-400 font-medium">
            © 2026 Inspiro. All rights reserved.
          </p>
          <p className="text-sm text-zinc-400 font-medium flex items-center gap-1">
            Daily <span className="text-brand-500">Inspiration.</span>
          </p>
        </div>
      </div>
    </footer>
