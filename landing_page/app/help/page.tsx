...
import { HelpCircle, Sparkles, Share2 } from "lucide-react";
...
export default function Help() {
  const categories = [
    {
      ...
      description: "How to find your daily dose of motivation.",
      href: "#"
    },
    {
      icon: <Share2 size={24} />,
      title: "Sharing Quotes",
      description: "How to share quotes with your friends and family.",
      href: "#"
    },
    {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-zinc-950">
      <PageHeader
        title="Help Center"
        description="Find answers, guides, and support for Inspiro."
      />
